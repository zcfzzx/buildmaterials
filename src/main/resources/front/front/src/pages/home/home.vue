...
<div class="recommend" :style='{"padding":"20px 7% 0","margin":"0","textAlign":"center","background":"none","display":"block","width":"100%","position":"relative","order":"2"}'>
    ...
    <div class="title" :style='{"margin":"20px auto 40px","borderColor":"#7e6b5a","outline":"1px solid #7e6b5a","alignItems":"flex-start","outlineOffset":"2px","background":"#f6f5f3","borderWidth":"1px 0","display":"flex","width":"auto","position":"relative","borderStyle":"dashed","height":"56px"}'>
		<span :style='{"padding":"0 20px 0 100px","fontSize":"18px","lineHeight":"54px","color":"#4e4e4e","background":"url(http://codegen.caihongy.cn/20230207/cb0df322e9b14cb3b11556207d9fab2b.png) no-repeat 20px -1px,#f6f5f3","fontWeight":"600"}'>商品信息推荐</span>
	</div>
	...
	<div class="list list4 index-pv1" :style='{"minHeight":"760px","width":"100%","padding":"40px 0 0","background":"none","display":"block","height":"auto"}'>
		<div v-if="shangpinxinxiRecommend.length>0" class="list-item animation-box" @click="toDetail('shangpinxinxiDetail', shangpinxinxiRecommend[0])" :style='{"cursor":"pointer","width":"20%","margin":"0","position":"relative","float":"right","height":"480px"}'>
			<img :style='{"width":"100%","padding":"50px 30px","objectFit":"cover","float":"left","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","height":"100%"}' v-if="preHttp(shangpinxinxiRecommend[0].tupian)" :src="shangpinxinxiRecommend[0].tupian.split(',')[0]" alt="" />
			<img :style='{"width":"100%","padding":"50px 30px","objectFit":"cover","float":"left","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","height":"100%"}' v-else :src="baseUrl + (shangpinxinxiRecommend[0].tupian?shangpinxinxiRecommend[0].tupian.split(',')[0]:'')" alt="" />
			<div class="title line1" :style='{"margin":"0 auto","whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"80%","lineHeight":"44px","fontSize":"14px","textOverflow":"ellipsis"}'>
                ...
                <div>品牌:{{shangpinxinxiRecommend[0].pinpai}}</div>
                <div>商家名称:{{shangpinxinxiRecommend[0].shangjiamingcheng}}</div>
            </div>
		</div>
		<div class="list-body" :style='{"width":"40%","margin":"0","float":"left","justifyContent":"space-between","display":"flex","height":"480px"}'>
			<div v-if="shangpinxinxiRecommend.length>1" @click="toDetail('shangpinxinxiDetail', shangpinxinxiRecommend[1])" class="list-item animation-box" :style='{"width":"50%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","padding":"50px 30px","objectFit":"cover","float":"left","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","height":"100%"}' v-if="preHttp(shangpinxinxiRecommend[1].tupian)" :src="shangpinxinxiRecommend[1].tupian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","padding":"50px 30px","objectFit":"cover","float":"left","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","height":"100%"}' v-else :src="baseUrl + (shangpinxinxiRecommend[1].tupian?shangpinxinxiRecommend[1].tupian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"margin":"0 auto","whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"80%","lineHeight":"44px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{shangpinxinxiRecommend[1].shangpinmingcheng}}</div>
                    <div>品牌:{{shangpinxinxiRecommend[1].pinpai}}</div>
                    <div>商家名称:{{shangpinxinxiRecommend[1].shangjiamingcheng}}</div>
                </div>
			</div>
			<div v-if="shangpinxinxiRecommend.length>2" @click="toDetail('shangpinxinxiDetail', shangpinxinxiRecommend[2])" class="list-item animation-box" :style='{"width":"50%","margin":"80px 0 0","position":"relative","flexWrap":"wrap","display":"flex","height":"100%"}'>
				<img :style='{"padding":"50px 30px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"100%","order":"2"}' v-if="preHttp(shangpinxinxiRecommend[2].tupian)" :src="shangpinxinxiRecommend[2].tupian.split(',')[0]" alt="" />
				<img :style='{"padding":"50px 30px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"100%","order":"2"}' v-else :src="baseUrl + (shangpinxinxiRecommend[2].tupian?shangpinxinxiRecommend[2].tupian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"margin":"0 auto","whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"80%","lineHeight":"44px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{shangpinxinxiRecommend[2].shangpinmingcheng}}</div>
                    <div>品牌:{{shangpinxinxiRecommend[2].pinpai}}</div>
                    <div>商家名称:{{shangpinxinxiRecommend[2].shangjiamingcheng}}</div>
                </div>
			</div>
		</div>
		<div class="list-body" :style='{"width":"40%","margin":"0","float":"left","justifyContent":"space-between","display":"flex","height":"480px"}'>
			<div v-if="shangpinxinxiRecommend.length>3" @click="toDetail('shangpinxinxiDetail', shangpinxinxiRecommend[3])" class="list-item animation-box" :style='{"width":"50%","margin":"0","position":"relative","display":"inline-block","height":"100%"}'>
				<img :style='{"width":"100%","padding":"50px 30px","objectFit":"cover","float":"left","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","height":"100%"}' v-if="preHttp(shangpinxinxiRecommend[3].tupian)" :src="shangpinxinxiRecommend[3].tupian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","padding":"50px 30px","objectFit":"cover","float":"left","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","height":"100%"}' v-else :src="baseUrl + (shangpinxinxiRecommend[3].tupian?shangpinxinxiRecommend[3].tupian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"margin":"0 auto","whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"80%","lineHeight":"44px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{shangpinxinxiRecommend[3].shangpinmingcheng}}</div>
                    <div>品牌:{{shangpinxinxiRecommend[3].pinpai}}</div>
                    <div>商家名称:{{shangpinxinxiRecommend[3].shangjiamingcheng}}</div>
                </div>
			</div>
			<div v-if="shangpinxinxiRecommend.length>4" @click="toDetail('shangpinxinxiDetail', shangpinxinxiRecommend[4])" class="list-item animation-box" :style='{"width":"50%","margin":"80px 0 0","position":"relative","flexWrap":"wrap","display":"flex","height":"100%"}'>
				<img :style='{"padding":"50px 30px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"100%","order":"2"}' v-if="preHttp(shangpinxinxiRecommend[4].tupian)" :src="shangpinxinxiRecommend[4].tupian.split(',')[0]" alt="" />
				<img :style='{"padding":"50px 30px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230207/346e413dce8f4515a5a57219df032ccd.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230207/e75d04594fa6401b9993f023e829f7b8.png) no-repeat right bottom / auto 100%","width":"100%","float":"left","height":"100%","order":"2"}' v-else :src="baseUrl + (shangpinxinxiRecommend[4].tupian?shangpinxinxiRecommend[4].tupian.split(',')[0]:'')" alt="" />
				<div class="title line1" :style='{"margin":"0 auto","whiteSpace":"nowrap","overflow":"hidden","color":"#fff","textAlign":"center","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(207,193,176,1) 20%, rgba(166,147,124,1) 50%, rgba(207,193,176,1) 80%, rgba(255,255,255,1) 100%),#a6937c","width":"80%","lineHeight":"44px","fontSize":"14px","textOverflow":"ellipsis"}'>
                    <div>{{shangpinxinxiRecommend[4].shangpinmingcheng}}</div>
                    <div>品牌:{{shangpinxinxiRecommend[4].pinpai}}</div>
                    <div>商家名称:{{shangpinxinxiRecommend[4].shangjiamingcheng}}</div>
                </div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('shangpinxinxi')" :style='{"border":"0","padding":"0 2px 0 10px","margin":"20px auto","textAlign":"center","display":"inline-block","minWidth":"120px","right":"calc(7% + 20px)","borderRadius":"8px","top":"28px","background":"none","width":"auto","lineHeight":"40px","position":"absolute","height":"44px"}'>
...
<div class="news" :style='{"padding":"0 7%","margin":"40px 0 0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","order":"3"}'>
	...
	<div class="title" :style='{"margin":"0 auto 20px","borderColor":"#7e6b5a","textAlign":"center","display":"flex","outline":"1px solid #7e6b5a","top":"0","outlineOffset":"2px","background":"#f6f5f3","borderWidth":"1px 0","width":"100%","position":"relative","borderStyle":"dashed","zIndex":"99","height":"56px"}'>
		<span :style='{"padding":"0 20px 0 100px","margin":"0 10px 0 0","color":"#4e4e4e","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230207/cb0df322e9b14cb3b11556207d9fab2b.png) no-repeat 20px -1px,#f6f5f3","width":"auto","fontSize":"18px","lineHeight":"56px","fontWeight":"600"}'>公告信息</span>
	</div>
	...
	<div @click="moreBtn('news')" :style='{"border":"0","padding":"0 12px 0 20px","margin":"0 auto","textAlign":"center","display":"inline-block","minWidth":"120px","right":"calc(7% + 40px)","borderRadius":"8px","top":"8px","background":"none","width":"auto","lineHeight":"40px","position":"absolute","height":"44px","zIndex":"99"}'>
		<span :style='{"color":"#333","fontSize":"15px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#333","fontSize":"15px"}' class="el-icon-d-arrow-right"></i>
	</div>
